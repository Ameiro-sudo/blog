...
// ============================================
var profileConfig = {
  avatar: 'https://vps.snowblock.top/raw/ninasukiwww-png/my-images/main/blog/profile.webp',
  name: 'ninasukiwww',
...
function resetOG() {
  ...
  setOGTag('og:image', 'https://vps.snowblock.top/raw/ninasukiwww-png/my-images/main/blog/bg.webp')
...
function loadArticle(id) {
  ...
  fetch('content/posts/' + meta.file).then(function (r) { return r.text() }).then(function (mdText) {
    ...
    setOGTag('og:image', meta.image || 'https://vps.snowblock.top/raw/ninasukiwww-png/my-images/main/blog/bg.webp')
