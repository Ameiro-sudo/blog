...
readTime: 10 分钟
pinned: true
image: assets/vendor/images/posts/cover-bocchi-2.webp
---

一个零后端静态单页博客。基于 Markdown 写作，构建时生成索引，GitHub Pages 托管，全站无数据库无服务器。所有源码在 [github.com/Ameiro-sudo/blog](https://github.com/Ameiro-sudo/blog)。
...
图片存储在独立仓库 [my-images](https://github.com/Ameiro-sudo/my-images)：
...
**图片引用：** 支持两种方式：
1. 直接粘贴 CDN 链接：`![alt](https://cdn.jsdelivr.net/gh/Ameiro-sudo/my-images@main/blog/xxx.jpg)`
...
所有图片通过 jsDelivr CDN 加载：`https://cdn.jsdelivr.net/gh/Ameiro-sudo/my-images@main/blog/`
...
- `fetch` 阶段：仅拦截 `cdn.jsdelivr.net/gh/Ameiro-sudo/my-images` 的请求，缓存到 `v1` 缓存
...
- GitHub: [Ameiro-sudo](https://github.com/Ameiro-sudo)
