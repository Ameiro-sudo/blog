const e="post7",n="Bocchi Client:从原版模板一步一步来的改造记录",t="2026-08-04",o="21:00",d="8 分钟",i=["Mod","开发记录"],l=!0,c="post7.md",h="",s="assets/vendor/images/posts/cover-104120832.webp",a="一直想要一个「孤独摇滚」主题的 Minecraft 客户端。机缘巧合之下,找到了baier233/bocchi-template-1.21.5 ,CC0 许可,随便用随便改,于是开始了这一步步改造（该说不说AI真好用吧，花了15¥就完事了） 声明：题主一点点程序能力都没有，顶多能看懂py的一些简单逻辑，所以本项目为纯vibecoding进行修改 第一版0.1.0相对原版模板,一共新增了 3 个文件",p=2614,r=`<p>一直想要一个「孤独摇滚」主题的 Minecraft 客户端。机缘巧合之下,找到了<a href="https://github.com/baier233/bocchi-template-1.21.5">baier233/bocchi-template-1.21.5</a>,CC0 许可,随便用随便改,于是开始了这一步步改造（该说不说AI真好用吧，花了15¥就完事了）</p>
<p>声明：题主一点点程序能力都没有，顶多能看懂py的一些简单逻辑，所以本项目为纯vibecoding进行修改</p>
<p>第一版(0.1.0)相对原版模板,一共新增了 3 个文件、修改了 21 个文件。这篇文章就记录下这些改动是怎么一步步来的。</p>
...
<li><strong>按钮风格</strong>:主菜单按钮图标为自绘 SVG,经 <code>design.json</code> 可换 (早期并入的 CozyUI-Plus 圆角控件素材已随 v1.0 移除,不再依赖外部图标素材)</li>
</ul>
<h2 id="下载">下载</h2>
...
<td><a href="https://github.com/Ameiro-sudo/bocchi-mod/releases/tag/v1.0.1-1.21.5">GitHub Releases: v1.0.1-1.21.5</a></td>
</tr>
<tr>
<td>1.21.1</td>
<td>Fabric / NeoForge</td>
<td><a href="https://github.com/Ameiro-sudo/bocchi-mod/releases/tag/v1.0.1-1.21.1">GitHub Releases: v1.0.1-1.21.1</a></td>
</tr>
</tbody>
</table></div>
...
<li>界面图标 / 配色 / 纹理均为自绘资源,经 <code>design.json</code> 定义,不依赖第三方素材
(早期并入的 CozyUI-Plus、MCsans-Plus、Emoji-Plus 素材已随 v1.0 移除)</li>
</ul>
<p>源码:<a href="https://github.com/Ameiro-sudo/bocchi-mod">github.com/Ameiro-sudo/bocchi-mod</a></p>
`,g={id:e,title:n,date:t,time:o,readTime:d,tags:i,pinned:!0,file:c,description:"",image:s,excerpt:a,wc:2614,html:r};export{t as date,g as default,h as description,a as excerpt,c as file,r as html,e as id,s as image,l as pinned,d as readTime,i as tags,o as time,n as title,p as wc};
